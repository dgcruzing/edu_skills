...
## ACS Learner Reading Heading Defaults

For ACS/VET learner readings in Google Docs, prefer the established native Docs profile unless a live template overrides it:

- Heading 1: 20 pt, bold, ACS navy `#1B2A6B`.
- Heading 2 / Heading 3: 16 pt, bold.
- 5E headings such as ENGAGE, EXPLORE, EXPLAIN, ELABORATE, and EVALUATE: ACS orange `#E8891A`.
- Other learner-reading subheadings: ACS navy `#1B2A6B` or ACS orange where an accent heading is useful.
- Body text: 14 pt, dark neutral `#1F2937`, Calibri-compatible.
- Always style the full heading paragraph range; do not exclude the final character before the newline.
