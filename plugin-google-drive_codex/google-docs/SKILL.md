...
## ACS Google Docs Learner Reading Default

When creating or substantially formatting ACS/VET learner readings in Google Docs, use this native Docs profile unless the user or existing template says otherwise:

- Language: Australian English.
- Font family: Calibri, with Arial acceptable where the existing Doc is already Arial-based.
- Main title / Heading 1: 20 pt, bold, ACS navy `#1B2A6B`.
- Subheadings / Heading 2 and Heading 3: 16 pt, bold.
- 5E stage headings: 16 pt, bold, ACS orange `#E8891A`.
- Other subheadings: 16 pt, bold, ACS navy `#1B2A6B` or ACS orange when used as a learner-guide accent.
- Normal body text: 14 pt, dark neutral `#1F2937`, 115% line spacing, modest space below paragraphs.
- Apply styling across the full paragraph range so the final visible character of each heading is not left unstyled.
- Use readable linked labels or linked URLs for references; do not leave source links unclickable.
